...
- Deployment added no migration and changed no production business row. Later separately authorized business mutations were limited to deleting the one empty shipment plus its audit row, and cancelling `SO-2026-000002` while releasing its 27 stock reservations plus the return audit row. No package, scan, finished-goods quantity, stock movement, user, role, permission, or other row changed.
