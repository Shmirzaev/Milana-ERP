...
## Shipment order selector, package readiness, and Sales-order create performance deployed (2026-09-02)
...
## Pending variant selling prices and automatic Sales Order pricing (local only, 2026-09-02)
...
- Local migration, guarded import, idempotency check, API/workflow tests, strict TypeScript, lint, source contracts, and signed-in browser QA passed. The local test clone contains the prices it can resolve; production remains unchanged at release `20260902_084754` and Alembic `0112_price_calc_requests` pending explicit deployment approval.
