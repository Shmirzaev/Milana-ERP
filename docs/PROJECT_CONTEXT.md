...
## Employee feedback applied to production (2026-09-16)

- Applied the user-supplied `Milana-xodimlar-2026-09-15--UZB.xlsx` feedback as a guarded data-only transaction. The first four sheets retain the prior report; changes are on the two added feedback sheets. Bright-yellow and `YOQ` markers indicate departures; the user separately confirmed the 12 unhighlighted `YOQ` entries. Original pale-yellow blank answer cells were not departure signals.
- Updated 73 existing employees: 34 employment statuses to `terminated`, and 39 other department, section or manager corrections. Added one explicitly listed Packaging employee with number 2375, supported by the saved 2026-09-14 old-ERP identity/number extract. Current old ERP required sign-in, so no fresh old-ERP validation is claimed. Total employee rows: 472 -> 473. No existing employee was deleted or renumbered; payroll, users, permissions, departments, organization units and positions were not changed.
- Five conflicting identity/department entries remain pending user clarification. Blank information was not guessed. The named 11-potok master and confirmed group assignments were updated; existing 10-potok manager links and the previously verified 7-potok master duty remain pending explicit replacement/revocation. The detailed Uzbek result and unresolved-field report are under ignored `outputs/feedback/Xodimlar-natija-2026-09-16.md` in the task worktree.
- Both active source manifests and slot states matched fresh origin/main and production-base before work: green `20260916_033607`, manifest `2eace9a6a0f8fdf1cb15acb87be8d45c9be5dbb4d2976db42418effb4ff97c32`; rollback blue `20260915_121653`; database `0129_user_access_policy`. No application deployment, migration, restart, image or traffic switch was needed or performed.
- Fresh verified backup: `/opt/milana-erp/shared/backups/milana_erp_pre_20260916_111237.dump`, mode 0600, 53,638,972 bytes, 1,178 restore objects, SHA-256 `ff480b22280467c25a7230247ddc5fe8efadd4e68cd62a7c2f5c5ef17e905981`; restore-list SHA-256 `2c58f4b7068233948ab914057b070cc392c58af084c8f721e47e9118dd05fd49`.
- Exact dry-run validation covered current employee snapshots, reference validity, factory, unique employee numbers and schema revision. The transaction locked employee/audit tables, preserved every unrequested employee column except normal updated timestamps, and validated new audit rows 20422-20495. Independent readback verified all 473 employee profiles, including 399 untouched rows, and unchanged department/org-unit/position records. All four internal/public health/login checks returned HTTP 200. No extra test suite, browser QA, benchmark or extended monitoring ran per the user's instruction. Historical audit risks are not claimed fixed.
- Worktree `C:/ERP/.codex-work/employee-feedback-20260916`; branch `codex/employee-feedback-20260916`, based on main `d21b43134a62d08c56be17d480c63fd1b49269f2`. Only this durable result record is committed; private source, exact plan, backup evidence and results remain in ignored outputs. Application rollback does not undo these HR changes; use a reviewed selective reversal from before/after evidence to preserve subsequent business activity.
