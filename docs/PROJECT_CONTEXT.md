...
## Receipt-based production timeline prepared (2026-09-10)

- User selected the labeled horizontal timeline: garment/fabric pictures, separate Cutting, Printing, Sewing, Packaging and Storage columns, sewing line and due date. Existing filters, factory scope, navigation, batch details and actions remain available; EN/RU/UZ labels and mobile scrolling are supported.
- Sewing acceptance now uses persisted `received_sewing` bundle quantities, grouped once for the page and attributed to the exact batch. Automatic workflow activation, planned line assignment and input counters do not prove receipt. Accepted available quantity is green; pending or partial acceptance is yellow, with ready/accepted amounts and sewn output shown separately. Partial physical output stays yellow even when the department has administratively completed with shortage. Skipped Printing and future stages are gray; blocked work and overdue text remain explicit.
- The process API adds receipt/output quantities without changing workflow transitions, mutation permissions, schema or business data. The previously executed BSOrder cleanup and passport verification are recorded below; this release does not repeat them.
- Dedicated worktree `C:/ERP/.codex-work/process-timeline-20260910`, branch `codex/process-timeline-20260910`, based on verified main `3aa22b5b` and active blue release `20260910_065757` / manifest `207d336b31b4675b3280f727706e6ffc8cde4e9217a8246c06013c683bc9f485`. Focused receipt/batch/idempotency tests and frontend timeline contracts, strict TypeScript and scoped ESLint passed. User requested fast deployment without extra tests/monitoring; immutable CI, backup, warm-up and immediate health/runtime checks are retained.
