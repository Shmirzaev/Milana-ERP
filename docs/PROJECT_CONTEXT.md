...
- Deployment added no migration and changed no production business row. Later separately authorized business mutations were limited to deleting the one empty shipment plus its audit row; returning `SO-2026-000002` and its 27 stock reservations plus the return audit row; and then permanently deleting that Sales order and its two item rows plus the deletion audit row. No package, scan, finished-goods quantity, stock movement, user, role, permission, or other row changed.
