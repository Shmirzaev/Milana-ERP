...
## Packing-list fabric receipts added; photo fabric name pending (2026-09-14)
...
- The **15 unnamed photo designs / 300 rolls / 7,485.4 kg remain unimported**, pending the user's fabric name. Their exact roll data and extracted swatches are prepared in `C:/ERP/.codex-work/fabric-import-20260914/outputs/fabric-import/`; all photo length totals reconcile after correcting one transcription error. Do not import the PDF/Excel receipts again when completing these remaining photos. The import script recognizes its already-created batch references and verifies their contents before skipping them.
