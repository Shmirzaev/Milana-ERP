...
## Remaining sticker packs and old-ERP catalog variants imported (2026-09-22)

- The user explicitly requested the missing model/variant records from old ERP and all eight held packs, with absent weight left blank. This follow-up resolves the eight held packs in the historical section below. All 994 unique packs from `sticker.zip` are now imported: 62,186 pieces, 25,370.41 kg known weight, one null weight; nine repeated printouts were not duplicated.
- Created approved standard catalog variants `XJ3062 / V-5709` (model 8161, old master 1803 / qolip 4396) and `PJ1239 / V-6184` (model 8162, old master 3286 / qolip 4465), using their authenticated old-ERP master and variant pages. Imported the actual model pictures, six/five source sizes, original operation names/rates/control settings and variant color where present. Preserved source URLs, hashes, fields and recipes in provenance. The 45/40 source operations use the existing three-factory catalog convention (135/120 scoped records); no payroll payments or material stock were created. XJ3062's source recipe remains provenance rather than an invented BOM item mapping.
- Atomically created eight PDF-evidenced receipts, packages, items, available stock rows, aliases and import scans in Finished Goods warehouse 8: six XJ3062/V-5709 packs (366 pieces), one PJ1239/V-6184 pack (80), and existing PM7007/V-3858 (48). Total 494 available pieces / 194.78 kg known weight. PM7007 QR `uzerp_ii_21492_1` has SQL/API null weight, as requested. Package IDs 9283–9290; existing catalog models were unchanged.
- Catalog manifest SHA-256 `b721b7fc6e4c38de456f78c29f70ea8da3e5eca6afc87faa54ce939501ab7bc3`; pack manifest `f0f79d5dfffdfe875bf5564cfcf6caa41776d8a2f34f2984dcc8735fbe87095c`. Zero-collision dry-run, atomic import, independent database readback, all eight internal and public authenticated QR lookups, both public catalog details/source-image hashes, cumulative 994 QR/alias mappings and all four health/login checks passed. Eleven focused importer tests plus compilation/diff checks passed. Audit entries 22590 and 22591 have valid hashes and predecessor continuation; no full historical audit-chain repair is claimed.
- Fresh pre-write backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260922_110000.dump`: 54805431 bytes, 1203 restore objects, SHA-256 `cdfee68d5e7169f016a24679ce965ca77b143c6fb4a01eb335d192a2a2868d87`; restore-list SHA-256 `e1ca45fb129c447caf081d99836546cffe54d871041718b835dfbf4268553349`.
- Both production VMs remain blue `20260922_043845`, with green rollback `20260920_030043` and database `0132_first_grade_singles`. Data-only operation; no application deployment, schema migration, merge, restart or traffic change. Known unrelated risks are unchanged.
- Worktree `C:/ERP/.codex-work/sticker-warehouse-20260922`, branch `codex/sticker-warehouse-20260922`; reviewed import code commit `a8aed204` pushed before application of data. Completion record committed separately. Evidence/report under ignored `outputs/sticker-held-20260922/`; original first-batch manifests retained. Legacy checkout preserved; durable record mirrored to Obsidian.
