...
## User access controls live; observation in progress (2026-09-15)
...
- Pre-activation signed local browser QA verified create/edit controls, inherited denial, added grants, isolated factory grants and effective preview; screenshot reviewed, no console errors. After activation, signed production browser QA verified Create/Edit and Planning's inherited production access, previewed a denial and cancelled it without saving. All 25 existing users' effective permission/factory/admin fingerprints matched the original snapshot immediately before activation; no production access settings or business records were changed. Ordinary sign-in/read activity timestamps may update.
...
- The required HIGH-risk 30-minute observer started at `2026-09-15T12:39:54.809964Z`; earliest finish `13:09:54.809964Z` (18:09:55 Tashkent). Evidence: `C:/ERP/.codex-work/user-access-20260915/outputs/deployment/20260915_121653-observation.json`. Observation and closing checks are still pending at this checkpoint. Do not overlap deployments, replace the rollback slot, or describe observation as complete based only on the application being live.
