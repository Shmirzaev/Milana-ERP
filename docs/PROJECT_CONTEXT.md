...
- Continued 2026-09-22 (latest local delta): recruitment, shipment, planning, waste, sewing-flow and daily-report, customer-history, work/print/purchase orders, payroll records, cutting passports, HR positions, Finished Goods, suppliers, departments, warehouses and forecast recommendations gained opt-in bounded SQL pages while retaining legacy response shapes; repeated traceability and stocktake reads were removed; finite write/JSON shapes gained rollback regressions; hidden frontend requests were gated by actual route/modal/reference need. Current ledger is **79 fixed,33 partial,15 open,48 remaining**. All work remains local and unpushed; no migration, merge, deployment or production contact.
