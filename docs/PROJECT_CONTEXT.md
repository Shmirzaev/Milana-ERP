...
- LIVE: backend/frontend green release `20260925_081526`, exact application commit `d4d9633d86a18f6bbf57c914fcaa31d4e665ccbb`, merged through PR #214. Both manifests, images, symlinks and slot states agree. Blue `20260925_073509` remains running for rollback. Frontend activated `2026-09-25T08:48:58.314443+00:00`.
- User clarified that Cutting must create bundles and print the sheet before recording fabric usage. This supersedes the preceding optional-passport UI: for standard orders with planned fabrics, the initial form now shows batch/bundle inputs without passport, consumption, rolls, operator or waste fields. The explicit deferred-usage API mode creates no material-usage rows, stock debits or fabricated actual consumption. Existing bundle quantities, sheet printing/completion and downstream handoff remain intact.
- Actual usage is entered later through the existing Edit cutting details action, including after printing/completion. The API exposes pending material entry for records with no usage/passport and zero recorded input, using the planned fabric relationships. The save locks the cutting record, validates every planned batch/unit and positive finite consumption, applies existing reservations/stock checks atomically, records material/waste details and audits the change. A repeated save is rejected before a second debit; any material shortage rolls back all debits and usage rows. Cancelled/rejected work remains blocked. Existing permission/factory checks and passport-based API behavior remain in place. Usluga is unchanged.
- Two focused regressions passed for print-before-usage, later entry after completion, unchanged bundle/output quantities, duplicate-debit rejection and multi-fabric shortage rollback. Scoped Ruff, existing frontend multi-material contract and whitespace checks passed. Immutable release CI [36111945387](https://github.com/Shmirzaev/Milana-ERP/actions/runs/36111945387) passed. Verified backup, candidate startup/runtime and four immediate health/login checks passed. Extra suites, browser/performance exercises and extended monitoring omitted per the continuing user instruction.
- Deployment changed no operational business record; no production bundle or material usage was created for verification. No schema migration; database `0133_storage_customers` and startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 25/100 connections and zero invalid indexes. Disk 77% backend / 69% frontend. Historical unrelated audit/security risks remain.
- Manifest `2db406c7e0c97740131ce5072552998754c084534a7ca6eed98ba388c84bdc3b`, archive SHA-256 `65fe9f8ce5231e1ee072a4586978588335b2bf6dc5e5570d091f6691d975b141`, 900 source files matched the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:3bf100bb74e516bd7bd57256d5244f3fec9b1536012281a3fa91d3fefa512beb`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:197a6cd4f41ea916a0714c5eecad9289011a4acb4801262770b23504c1f0a18e`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260925_081526.dump`: mode 0600, 54492638 bytes, 1203 restore objects, SHA-256 `4a466e85e1cc52e48964a0f3c57f67b36787d41d813602e35ce5bdf527a91ca6`, restore-list SHA-256 `82ba87c63b334ae69d6daabb99d1216256a387e16ff3aca509e48fbcd096ac26`. Retained rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/cutting-sheet-deferred-usage-20260925`; application branch `codex/cutting-sheet-deferred-usage-20260925` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.

## Optional cutting passport deployed (2026-09-25)

- LIVE: backend/frontend blue release `20260925_073509`, exact application commit `946ecd9771fc834bfae2f30c035a52fe42e60015`, merged through PR #212. Both manifests, images, symlinks and slot states agree. Green `20260924_210134` remains running for rollback. Frontend activated `2026-09-25T08:08:10.091576+00:00`.
- Cutting bundle creation no longer requires a cutting passport. The EN/RU/UZ selector explicitly offers manual consumption without a passport, including when an existing passport is available. Selecting a passport retains the existing passport-derived consumption path. Manual mode restores actual fabric consumption and cutting-detail inputs for each planned fabric; it submits those materials through the existing API. No planned estimate is substituted for actual usage. Positive consumption, planned-batch/unit matching, stock checks, production-batch selection and downstream quantity limits remain enforced by existing backend logic.
- This is a frontend-only change. No schema, authorization or business record was changed by deployment; no production bundles were created for verification. Database remains `0133_storage_customers` and startup seeding is disabled. The previous batch-plan reduction fix and payroll changes remain included.
- Existing multi-material UI contract and whitespace review passed; its contract expectations were updated for the optional passport flag. Immutable release CI [36108395586](https://github.com/Shmirzaev/Milana-ERP/actions/runs/36108395586) passed. The broad local translation scan reported existing missing keys outside the changed cutting flow; all newly introduced keys are in EN/RU/UZ source and runtime dictionaries. No extra local suite, browser/performance exercise or extended monitoring was run, per user request. Verified backup, candidate startup/runtime and four immediate health/login checks passed.
- Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 23/100 connections and zero invalid indexes. Disk 77% backend / 69% frontend. Historical unrelated security/audit risks remain.
- Manifest `a301d56705012e9445050990fb5ccbcd5fd3babe3886b01697fc5248f31a7c28`, archive SHA-256 `3061d74caa598c090ecb68f37e3f3f9a901dcedc2de4ff3a383ca79e8bd97c74`, 899 source files matched the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:be4c736b2449017b0bfeb31e353e7a4cec68c42b62661193278bef08ba96ef03`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:1773376e899077573406bdcbf417d7fe6789b411886f2327c90b9abf16f1be5f`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260925_073509.dump`: mode 0600, 54492644 bytes, 1203 restore objects, SHA-256 `e16c50edd815a6762d7431b32e20ca3fac227d81810171f766b051b720303b48`, restore-list SHA-256 `d2414d7f4f6915ace521cb41b972c179451ff5f409a412940a51514e5302c00d`. Rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/optional-cutting-passport-20260925`; application branch `codex/optional-cutting-passport-20260925` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.

## Cutting batch quantity below original plan deployed (2026-09-25)

- LIVE: backend/frontend green release `20260924_210134`, exact application commit `025d3c612020d07be992fd5ab0cdb93af857f4e2`, merged through PR #209. Both manifests, images, symlinks and slot states agree. Blue `20260924_202614` remains running for rollback. Frontend activated `2026-09-24T21:34:57.911047+00:00`. This release followed the other task's completed payroll deployment and includes that deployment's recorded baseline; neither its CI nor its production switch was interrupted.
- Cutting may now reduce a standard batch plan below the original production-order target, including the reported 600-to-325 case. The order's original target and item breakdown remain available for comparison. Positive quantities and the existing lower bounds for live bundle quantities, cutting output and downstream commitments remain enforced. Existing work-order plan reconciliation, Cutting/Planning authorization, factory scope, locks and audit entries remain in place. Usluga behavior is unchanged.
- Extended the existing Cutting-to-Sewing workflow regression with the 600-to-325 save, unchanged 600-piece order target, revised work-order plans and zero actual output; the same regression continues to cover later overproduction and rejection below recorded downstream evidence. Scoped Ruff and whitespace review plus immutable release CI [36058765037](https://github.com/Shmirzaev/Milana-ERP/actions/runs/36058765037) passed. Verified backup, candidate warm-up/runtime and all four immediate health/login checks passed. Extra local suites, browser/performance checks and extended monitoring were omitted at the user's explicit request.
- Deployment changed no order, batch quantity, stock, scan, permission or operational business record. PO-0196 was only inspected read-only to diagnose the original error; its batch is edited only when a user saves. No schema change; database `0133_storage_customers`, startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 15/100 connections and zero invalid indexes. Disk 77% backend / 68% frontend. Historical unrelated audit/security risks remain.
- Manifest `2113bdd81ca4a8e561ff7c76260ef4e9bceb6f1d73eb8164a8062735397c1dad`, archive SHA-256 `c5952a3d3dfb586e745ab130313d472114cfb83be446efcadc378f96767d75fd`, 899 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:2bc59be8b7a63475c969a6dd9a7df537a9af02163d38ed06ede229f89e3862ba`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:bb55cf51818f5e2727484491ee47899f64862825485d931c4cd47f871a9767c8`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260924_210134.dump`: mode 0600, 54475361 bytes, 1203 restore objects, SHA-256 `12ab854aef337b2fd8a2fa553fc47f11d9c7f4405db2c6376e328947f897fb6f`, restore-list SHA-256 `678f08bd32c3f98f619d0dd4f9554b60921f6d8bfd4144ee711748fe85dec8f8`. Retained blue rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/cutting-batch-reduction-20260925`; application branch `codex/cutting-batch-reduction-20260925` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- LIVE: backend/frontend green release `20260924_120531`, exact application commit `c396dc54edc963802b4b765e019bf2413c1e18db`, merged through PR #206. Both source manifests, symlinks, images and slot states agree. Blue `20260924_100322` remains running for rollback. Frontend activated `2026-09-24T12:39:51.350274+00:00`.
- Shipment History has an actual Return to preparation action for shipped and delivered shipments in EN/RU/UZ. A reason and confirmation that all packages are back restores the existing stock, clears shipped/delivered timestamps and opens the same shipment in Shipments. Package links and original dispatch/invoice evidence remain auditable. Packages must be rescanned; any agreed invoice total must be reviewed again before redispatch.
- Reversal is atomic and locked. Paid/external invoices, orders shared with other shipments, conflicting reservations/package links, stale requests and incomplete stock are blocked for reconciliation. Unpaid invoices are voided/zeroed; generated manual accounting orders are cancelled/zeroed and detached. Ordinary sales orders return to ready_to_ship with their reservations. Redispatch creates fresh accounting. Finance/1C payment paths reject reversed invoices and 1C cannot invoice a cancelled order.
- No permissions, schema or operational business records were changed by deployment; no production shipment was actually reopened. Database stays `0133_storage_customers`; startup seeding disabled and migration startup is a no-op.
- Eleven focused shipment/finance/1C checks passed, plus scoped Ruff/ESLint, strict TypeScript and whitespace review. Required immutable release CI [35996900747](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35996900747) passed. Verified backup, candidate startup/runtime and all four immediate health/login checks passed. Extra local suites, browser/performance exercises and extended monitoring omitted at the user's explicit request.
...
- Manifest `703f9bfe527c5857e92d1d84aeece76c5e7b647158d366a1e36d71745565729f`, archive SHA-256 `d1c9c83c3d4083d9dd26d88272426b01c2e9dce309a759561717ae11769ff224`, 899 source files matched the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:861647ac7bbe74d8fc204c017110a034f0ff0bbc577f762a5dcb6505dab6c67d`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:4a56a561ad71b6bbb081fb76b5dcfa60e6fcfa1976e3dceed0c3d7ae8677e1e2`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260924_120531.dump`: mode 0600, 54463583 bytes, 1203 restore objects, SHA-256 `4ddc3843bbf319551e951d632a0fbc00be568043c358b5b3487cf61af548066f`, restore-list SHA-256 `0db7642986a7d5bde457653842ce61e95d135910da3fc9b5b43d749eda9722d0`. Rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/shipment-reopen-20260924`; application branch `codex/shipment-reopen-20260924` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- Shipment History uses green for shipped/delivered and red for draft/created, with neutral cancelled status. Explicit Back to shipments and Open shipment links support returning to the selected workspace. Shipments now share one compact table with per-row expansion and expand/collapse all; forms remain mounted after first opening so edits survive collapse, and requested links expand the relevant row.
- Printed invoices use smaller type, corrected column widths, non-wrapping row numbers, aligned sizes, Milana navy headers and green totals. Totals sum recorded weights despite missing weights, which remain visibly unknown and are identified by a partial-total note. Print and Excel rows follow valid successful scan order; detached/duplicate scans do not distort order. Missing historical scan evidence retains original relative order. Frozen snapshots and financial totals are not modified.
- Read-only, permission-protected invoice Excel export is available in shipment workspaces and history, with matching metadata/scan order/partial-weight totals, shared package-weight cells, literal text, localized EN/RU/UZ labels and print layout. Downloads use shipment business numbers. No permissions, schema, customer, shipment, stock or other operational business records changed by deployment. Database stays `0133_storage_customers`; startup seeding disabled and migration startup is a no-op.
- Focused export/partial-weight/shared-pack/literal-text, scan-order and frozen-document checks passed after synthetic fixture corrections. Scoped lint, standard/strict TypeScript, shipment contract and whitespace checks passed. Required immutable release CI [35984983222](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35984983222) passed. Verified backup, candidate startup/runtime and all four immediate health/login checks passed. Extra local suites, browser/performance exercises and extended monitoring were omitted at the user's explicit request.
- Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 22/100 connections and zero invalid indexes. Disk 76% backend / 68% frontend. Historical unrelated security/audit risks remain.
- Manifest `dd684de6696e4678d351e2d257bb68f452051ef90c63009ce3369182d6365ef0`, archive SHA-256 `b7cb98d0f1674c0ba7132370dd19c0a84356b2a94a6d71b6a0caf1b9dd8aa414`, 896 source files matched the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:3b28c93505b40a24f4340b9f65a6cfa2c5f4f933815ac65b618ad9de0eb230c1`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:6d1e91b1fc5df18f282d2d2a49f03a2599876ada7dd3049065d794cd41c07513`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260924_100322.dump`: mode 0600, 54463182 bytes, 1203 restore objects, SHA-256 `d17b50353afcf3ce86e87e1cbb70446d36d65eeef390ad41ad4e948dd4efbcab`, restore-list SHA-256 `9c0eed7a5497cb85556d58f70a8b4f05d3e497e2a16053ae1a8c1b0bcacefd26`. Rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/shipment-invoice-polish-20260924`; application branch `codex/shipment-invoice-polish-20260924` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- Manual shipments now save, dispatch and deliver without variant prices. Warehouse invoices print from the shipment after scanning (Draft before dispatch) and after dispatch with a pending-price label. Missing values remain unknown; no zero-valued Finance receivable is fabricated. Warehouse staff can later add the agreed invoice total through Shipment History or the shipment workspace. The original unpriced snapshot is retained, one accounting invoice is created, and stock is not deducted again. Catalog prices are not changed by the amount review.
- Local validation already passed 1,011 backend tests, a final 11-test manual-dispatch recheck, Ruff/compile, frontend lint/strict types, all contracts and optimized build. Required immutable release CI [35959129057](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35959129057) passed. Verified backup, candidate warm-up/runtime and all four immediate internal/public health/login checks passed. Extra test runs, browser/performance exercises and extended monitoring were omitted at the user's explicit request.
- No schema or permission change; database `0132_first_grade_singles`, startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers, PostgreSQL 22/100 connections and zero invalid indexes. Disk 75% backend / 68% frontend. No production business records were created, changed or deleted by deployment. Historical unrelated security/audit risks remain.
- Manifest `a03245a737269ff361e281118b6eaa3cc121233bec76dc08e78e5d5e71a5b1dd`, archive SHA-256 `01016466dab06420e27d144f42e89abce17b35ed83557c6b02f24e7cee1f896c`, 888 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:3786ff712b6a66e06588e74def4ca5f449d99b868dc4678b3f2650da88c3a0ac`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:89b619af2951d59e5b78b533601ea78d676aff83e363042fd0160793036be201`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260924_051514.dump`: mode 0600, 54263245 bytes, 1203 restore objects, SHA-256 `1b1ac5eae357f83ced2cb9aa2b876da76356e9eb2a44750da424df5d87768951`, restore-list SHA-256 `365fa653d6cf2feaa2074f351224d94a8d1758c865118d647ce10de862541d8f`. The rollback application uses the same schema; already-dispatched pending-price documents must be completed with this version or a forward fix, because the previous version cannot add their amount after dispatch.
- Worktree `C:/ERP/.codex-work/manual-shipment-unpriced-20260924`; application branch `codex/manual-shipment-unpriced-20260924` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- LIVE: backend/frontend green release `20260923_094746`, exact application commit `3d63d77f72376e1cafd97795ff9ed41e7b190444`, merged through PR #198. Both manifests, images, symlinks and slot states agree. Blue `20260923_090323` remains running for rollback. Frontend activated `2026-09-23T10:26:16.403566+00:00`.
- User clarified that multi-select deletion belongs inside an open inventory count's scan-history table. Added per-scan checkboxes, select-all for the current page and a localized Delete selected scans action with a selected count and confirmation. Only recorded scans can be selected; filtering/search/pagination clear selection. Controls are blocked during pending scans or deletion and completed counts remain locked. Existing saved-count deletion remains available separately.
- The bounded API validates every selected row under the existing parent count lock before making changes, requires existing warehouse access and writes the existing undo_scan audit entry per row. Expected rows lose only scan evidence and return to missing; unknown/unexpected/ambiguous scan rows are removed. Packages, stock balances, reservations and the count-start snapshot remain unchanged. No production scans or business records were deleted during deployment.
- Scoped Ruff and whitespace review passed. Existing immutable release CI [35845339672](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35845339672) passed, including bulk atomicity, cross-count isolation, completed-count locking, audit, unchanged stock and permission coverage. Verified backup, candidate warm-up/runtime and all four immediate health/login checks passed. Extra local suites, browser/performance checks and extended monitoring were omitted at the user's explicit request.
- No schema or permission change; database `0132_first_grade_singles`, startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 24/100 connections and zero invalid indexes. Disk 75% backend / 67% frontend. Historical unrelated audit/security risks remain.
- Manifest `8382a08dcfc0f5c2a80d0f5af0f1d2ed53d039308cbbe78337367a53bfa23d73`, archive SHA-256 `966160bd28e90dc77c283dd6468f089b08a96096b6fbe43be71d56285cf7cf09`, 888 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:d08f6c57d7da24652dedd99882d16a9716cbdcf42e49edf19a5427c71501335c`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:69665472b8f2931b030e71c019ed3303db7c2579074ffa7db60da7187c47ddf1`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260923_094746.dump`: mode 0600, 54216330 bytes, 1203 restore objects, SHA-256 `07e0b0bb6b9dde13d67a392d2da4e9df82c7582b8388aa083f35201945f15f59`, restore-list SHA-256 `daecb2d93305df82f55848583e7ab2edcf74febde48f51b89f2b116a29f397d7`. Retained blue rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/stocktake-bulk-scan-delete-20260923`; application branch `codex/stocktake-bulk-scan-delete-20260923` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.

## Finished-goods Excel names, colors and formatting deployed (2026-09-23)

- LIVE: backend/frontend blue release `20260923_090323`, exact application commit `b1ad090405a91d1422449e9c8af364e5fa602cd6`, merged through PR #196. Both manifests, images, symlinks and slot states agree. Green `20260923_060425` remains running for rollback. Frontend activated `2026-09-23T09:38:21.402636+00:00`.
- Updated the existing warehouse-report.xlsx export and button path; no separate report. Six columns are model number, exact stored product name, variant number, actual stored catalog colors, packages and pieces. Removed only the sequential numbering column. Blank names stay blank; missing colors use an em dash; multiple catalog colors share one cell. Existing number resolution, row grain, sorting, inclusion rules, quantities, standard/first-grade sheets and totals remain unchanged. Color loading occurs separately from the aggregate query; no images are loaded.
- Calibri 11, thin borders, subtle alternating rows, bold headers, wrapped names with explicit row heights, left-aligned descriptive text, right-aligned quantities and distinct totals. Filters and frozen headers remain. Separate title, dynamically generated export time explicitly labeled Tashkent UTC+05:00, actual ERP finished-goods/stock-kind source and the existing reserved/unplaced scope note. Export time is not described as a stock snapshot timestamp. RU/EN/UZ report localization is retained; product data is never translated.
- Requested sample verification passed on a read-only repeatable-read production transaction: all 1,895 rows matched stored names/colors, and old/new totals matched 6,238 packages / 449,855 pieces. First Grade was empty. 317 rows had no recorded catalog color and 208 names were stored blank. Дата и время экспорта (время Ташкента, UTC+05:00): 23.09.2026 14:01:23. Formula recalculation matched the same totals with zero formula errors; both sheet layouts, longest stored name and totals were visually checked. Sample `outputs/warehouse-excel-details-20260923/warehouse-stock-sample.xlsx`; evidence `verification.json` in that directory. Verification did not change production data.
- Two focused exporter regressions, scoped Ruff/whitespace checks and standard immutable CI [35840675794](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35840675794) passed. Verified backup, candidate warm-up/runtime and all four immediate health/login checks passed. No extra browser/performance suite or extended observation was run, preserving the user's earlier deployment preference.
- No schema or permission change; database `0132_first_grade_singles`, startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 24/100 connections and zero invalid indexes. Disk 75% backend / 67% frontend. Historical unrelated audit/security risks remain.
- Manifest `5cf922d4ef50640174361486e1c992ae3183f7e3aa574c0441f36590872a32ec`, archive SHA-256 `a3be83a9b90a4f36e76980e4cbe61a58e731d6258092aed522409b3109a31006`, 888 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:f12c9bf1bdf5668a27962866113aa194f88937f724665a96f087efed0571897c`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:ce57863fa4cb14c42a6f15ef76855ea12848df1e11acff895c34e77e50fb8028`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260923_090323.dump`: mode 0600, 54216334 bytes, 1203 restore objects, SHA-256 `f39c1f3522da72f327477a71cbd771fd0f93dd0338a7c128ae00774fb1d7a026`, restore-list SHA-256 `6c41ad8ecfaeb303ff3e570d083dcac2be3ca1ea59bb5ecb436ff7d7a86fdf50`. Retained green rollback uses the same database revision.
- Worktree `C:/ERP/.codex-work/warehouse-excel-details-20260923`; application branch `codex/warehouse-excel-details-20260923` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- Warehouse Stock prioritizes model/variant code matches: searching 1718 no longer includes unrelated models merely because a package, barcode or order contains those digits. Cards, detail rows and totals share the same filtered results. Other-field fallback remains available when no model code matches.
- Inventarizatsiya Saved counts supports selecting individual reports or the current page (up to 50) and deleting them with one EN/RU/UZ confirmation. The existing warehouse permission protects the bounded endpoint; selected parents are locked in ID order and all IDs validated before any deletion. Only count reports and their scan rows are removed, with per-count audit entries. Warehouse packages, reservations, stock and receipts are untouched. Completed and in-progress reports can be deleted explicitly. No production records were deleted during this deployment.
- Scoped Ruff/whitespace checks and standard immutable CI [35825088483](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35825088483) passed, including deletion authorization, atomicity, isolation and unchanged-stock coverage. Verified backup, candidate warm-up/runtime and all four immediate health/login checks passed. No additional local suite, browser/performance exercise or extended monitoring ran, at the user's explicit request.
- No schema or permission change; database `0132_first_grade_singles`, startup seeding disabled. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 23/100 connections and zero invalid indexes. Disk 74% backend / 67% frontend. Historical unrelated audit/security risks remain.
- Manifest `090918dbd4d8a7d1643d1fc1cab20463521abd49496d0b95f1cc31b0dd1fd5ec`, archive SHA-256 `8f778a3ab5f56f995c84ac5c1b1e3a41985bdf8e710070e517f1e58d058353e0`, 887 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:56d81b5ba197045951d85b2b9ff51ea05808081e23a90156924bac4ec4a0531d`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:9a7e6b7aca8708d7d7f189ca7262602d4bef08a9fa0c69160be0d39b57b24792`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260923_060425.dump`: mode 0600, 55353493 bytes, 1203 restore objects, SHA-256 `07f9ebeb556ceb9162d4a5f5f59cfe38450b0f214606a5fb616a902233881b2d`, restore-list SHA-256 `449e0fb84f471cee9dfe7f29b0e57a57675b3c3a8c08e45e40b0190234d643da`. Rollback keeps the previous blue application with the same database revision; rollback would not restore reports deleted later by users.
- Worktree `C:/ERP/.codex-work/warehouse-search-stocktake-delete-20260923`; application branch `codex/warehouse-search-stocktake-delete-20260923` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- Fabric availability is checked when creating/updating a cutting passport, with EN/RU/UZ batch and quantity errors. A cutting sheet from a valid saved passport can be created even when its material stock/reservation is insufficient. Its material debit rolls back atomically; full undeducted usage/reason remains in `CuttingMaterialUsage.details.inventory_consumption` and audit history for later reconciliation. Sufficient stock is consumed normally; duplicate-passport guards and non-stock validation remain. No stock is invented and future receipts are not automatically debited for pending usage.
- Read-only diagnosis found passport 9186 / batch 0260-01 needs 175 kg from fabric lot 6259 with zero stock. Deployment did not submit this sheet, create its bundles, or modify any business record. Existing data and schema remain unchanged, database `0132_first_grade_singles`, startup seeding disabled.
- Five focused passport/cutting regressions and scoped Ruff passed locally. Standard immutable CI [35687668128](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35687668128) passed backend/frontend validation and built exact-commit artifacts. At explicit user request no extra browser/performance exercise or extended monitoring ran. Backup, warm-up, runtime checks and all four immediate health/login checks passed. No extended observation is claimed.
- Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 22/100 connections and zero invalid indexes. Disk 73% backend / 66% frontend. Pending material consumption requires later explicit reconciliation; unrelated historical audit/security risks remain.
- Manifest `3cdfffe32807a4815d39ada8afc5f43ec5807aa5da6c2da168de3aa776fa4b7d`, archive SHA-256 `a7c02719965ab2f1f92cd60242911cf635ff3435d8c45167703d35aa22e3b8e6`, 885 files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:f9555466edc2825df53ee84276919ac6a1b0687a194cbd334814c2a980d4050e`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:192685862c2b03834dfcbc3a7c1b4029b70033ee52c2cfeee262fcf6ead305b4`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260922_043845.dump`: mode 0600, 54658631 bytes, 1203 restore objects, SHA-256 `80bcd3ff2c61d0ff667062cc4f26370d703db1a4f27acf55123f288c5fea35bf`, restore-list SHA-256 `4361a20c5776c22a6d9101d79536db094fd2f778e5cfc830ab7f115e5bede55a`. Rollback retains the prior green application with the same database revision.
- Worktree `C:/ERP/.codex-work/cutting-passport-stock-20260922`; branch `codex/cutting-passport-stock-20260922` pushed/merged/deployed. Evidence `outputs/deployment/evidence.json`. Deployment record committed separately and mirrored to Obsidian; legacy checkout preserved.
...
- LIVE: backend/frontend green release `20260920_030043`, exact application commit `f78b8b68067521ff0478e3a3b7210b3d4d57d2e9`, merged via PR #185 (merge `a5cebb5f2941597b2ad4e236b33cd961ff87fa61`). Both source manifests, immutable images, current symlinks and slot states agree. Blue `20260919_120429` remains running for rollback. Frontend activated `2026-09-20T03:27:58.717917+00:00`.
- Awaiting Packaging uses the actual production number. Warehouse model links open a separate tab listing each package's barcode, size contents, quantity, available/reserved stock, weight, location and receipt date, with pagination. A4 package labels start immediately without the print-run QR cover and show a page number on every page.
- First Grade means quality-approved singles lacking a complete size assortment. Packaging allocates one exact-size piece per QR from accepted Sewing size evidence and the same locked batch/output budget as normal packs. Warehouse receipt is required; a separate singles tab and per-piece sales reserve only received singles. Normal pack selection excludes singles. The packaging form's color casing is matched case-insensitively against production evidence. Customer-owned/Usluga output cannot be diverted into free stock. Historical missing size evidence or mixed-batch ambiguity requires reconciliation; recombination and post-delivery commercial returns remain future operations. See `docs/FIRST_GRADE_SINGLES_WORKFLOW.md`.
- Mistaken manual shipments can be deleted before dispatch; scanned package links are released atomically and audit history retained. Sales-linked, shipped and delivered shipments are protected, and deleted creation requests cannot recreate a shipment. No existing shipment was deleted and no existing stock quantity was changed by this release. Migration `0132_first_grade_singles` adds package classification (existing stock defaults to standard) and shipment deletion timestamps; seeding stayed disabled.
- CI [35485464841](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35485464841) passed 1,001 backend tests, 11 observer tests, PostgreSQL migration up/down/up, concurrent final-size allocation, stock conservation and downgrade guards, Ruff/compile, frontend strict types/contracts and optimized build. Lint has zero errors and four inherited warnings. Signed local QA verified 18 matching frontend assets, correct production references, singles creation/balance, separate stock and piece sales, new-tab package details, RU/UZ deletion confirmations and EN/RU/UZ copy, with zero changed-page browser errors. Five labels rendered as two numbered A4 pages without a cover. Production API checks were read-only; all 24 public assets across five changed routes match the activated image. Signed live read-only browser QA completed after user sign-in on 2026-09-20: separate empty singles stock and per-piece sales form, actual model link opening a new tab with package contents/availability/weight/receipt, First Grade panel with the localized Uzbek missing-size-evidence guard, and the delete control on an existing undispatched manual shipment. Packaging floor loaded with production references; no Awaiting Packaging rows were present, so its populated-row behavior remains covered by local/API tests. No business records were created, changed or deleted. Checked-page browser logs were empty.
- Candidate performance passed 63 alternating samples per slot/endpoint after 10 warmups across ten endpoints, including stock, shipments and packaging. Public immediate and closing comparisons use a fresh pre-cutover HTTPS baseline. All comparisons preserve the 10% median / 15% p95 / 15% payload thresholds and identical result counts. High-risk observation completed `2026-09-20T03:28:03.023165+00:00` to `2026-09-20T03:58:03.190504+00:00`, 61 rounds of all four required endpoints, zero failures. Closing runtime, source/slot, strict logs, database, health and public performance checks passed.
- Two workers per backend slot, zero restarts/OOM/error markers. PostgreSQL 24/100 connections and zero invalid indexes. Disk 74% backend / 66% frontend. Historical unrelated security/audit risks remain unchanged. Rollback to the older application must first verify that no new singles or shipment tombstones have been used; otherwise use forward repair or controlled reconciliation, because the old application does not understand them. No blind schema downgrade.
- Manifest `6e0fe7e13abf717b544995c5e06a7628636ecd8919236cc89f08117660b391e2`, archive SHA-256 `8b32a6210cf9e18c7ed884a4bfac8f14c4b9d6420097ac252e5dbad4ca44a5b1`, 885 exact-commit source files verified. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:802b1b1f7366fe6f542a348a6df9ebeb087652475c92cc2e41857be8a629f010`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:c09787972484030fd524382df1f5873b6e05ff28875f0a8c2596d6c0349e0cd5`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260920_030043.dump`: mode 0600, 54471947 bytes, 1202 restore objects, SHA-256 `68a3964e14b3012c0958201d8b3351c7d811b63d28fb513161e2102ee75fa686`, restore-list SHA-256 `f2927ea61814b411c81a4a819967d89e5f28a2d1aca1b776c78b1e8c88e0672c`.
- Worktree `C:/ERP/.codex-work/first-grade-warehouse-packages-20260919`, application branch `codex/first-grade-warehouse-packages-20260919` pushed, merged and deployed. Evidence is under `outputs/deployment/` and `outputs/qa/`. Legacy checkout preserved. Durable release/base record committed separately and mirrored to Obsidian.
...
- Completes the selected-language handling for local Planning validation, HR error prefixes and report-download network failures; structured API validation details normalize safely, and fabric/Eco/sewing correction handlers retain their original machine codes. Awaiting Packaging labels the order-number column and prefixes branded orders with BSO. The complete application diff against the prior live release is display-only: no backend, schema, business-data, permissions, inventory quantities or scan-state changes. Item8 remains proposal-only.
- Immutable CI [35441916421](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35441916421) passed 986 backend tests, 11 observer tests, frontend error/workflow contracts, strict types, lint (zero errors, five inherited warnings) and optimized 89-route build. Signed local QA used 15/15 matching served build assets after the user restarted the preview. Russian and Uzbek client-side validation and BSO/model/variant packaging references were verified without business writes. Changed-route browser error logs were empty. Public read-only browser QA also passed.
- Prior high-risk 30-minute observation and closing checks completed before replacing the inactive blue slot. This follow-up completed its full low-risk 10-minute observation from `2026-09-19T12:27:00.037257+00:00` to `2026-09-19T12:37:00.272554+00:00`, 21 rounds of four required endpoints, zero failures. Closing source/slot/runtime, strict logs, database and public performance checks passed. Candidate performance used 63 alternating samples per slot after 10 warmups; public performance compares the same HTTPS routes with a captured pre-cutover baseline. All comparisons retained the 10% median / 15% p95 / 15% payload thresholds and identical row counts.
- Two workers per backend slot; zero restarts/OOM/error markers. PostgreSQL 25/100 connections, zero invalid indexes; disk 74% backend / 66% frontend. Database remains `0131_sewing_corrections`; startup migration was a no-op and seeding disabled. Historical unrelated audit/security risks remain unchanged.
- Manifest `99dcad2426398293320870c7d626d25ffe3450e438cbee3d075fff7d680ce19f`, archive SHA-256 `347da413d34b27fe4b1f787e0e686d61fecf8c5361718ffc3d447d7970f91f02`, 876 source files verified against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:a2f35a870baf44fb4dbbcd748a63da817e8f7f812bb2b2aaa199089b1af3adc5`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:d81981939ab8c47d38317edf63de48cbb20e98e40de930365591487110f73561`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260919_120429.dump`: mode 0600, 54461462 bytes, 1202 restore objects, SHA-256 `0f13ba8785be63fc26aadbf58f5aadbd8d89b1af9d82f8ad26aca2dc84dd1346`, restore-list SHA-256 `d933fa9d1f76384d851ce046edcf210297f284e627c55f1c618ffb6932484a2b`. Rollback to green preserves the completed shipment reset; no database downgrade.
- Worktree `C:/ERP/.codex-work/cutting-shipping-packaging-20260919`, application branch `codex/complete-workflow-locales-20260919` pushed, merged and deployed. Evidence `outputs/deployment-locales/`; previous release and cleanup evidence `outputs/deployment/` and `outputs/cleanup-evidence.json`. Legacy checkout preserved. Durable context/base record committed separately and mirrored to Obsidian.

## Cutting, shipment and packaging updates deployed (2026-09-19)

- Prior completed release: backend/frontend green release `20260919_113426`, exact application commit `c88524c7badce443ba4494e4127eec17bababc0f`, merged through PR #182 (merge commit `93271530138bb891340d6f0132c3d15ec18daeac`). Both current symlinks, source manifests, image identities and slot states agree. Blue `20260918_121209` was retained through this observation; the completed follow-up above now uses green as rollback. Frontend activated `2026-09-19T11:49:18.834776+00:00`.
- Planned-material Cutting reads usage from its saved passport through existing transactional warehouse consumption; the duplicate Material usage panel is removed. Reusing an already-consumed passport is blocked before another debit. Legacy/Usluga entry remains. Cutting floor supports typed Search and Enter. Scanned package rows have an X/Return to inventory button through the existing audited pre-dispatch removal endpoint. Shipment history has its own route/sidebar section. Awaiting Packaging shows business order references, model/variant and their thumbnails.
- Shared API/network/export errors render in selected EN/RU/UZ. Common cutting/shipping errors have specific translations; unknown backend messages use localized status fallbacks. ApiError retains original detail/status for diagnostics and existing machine-code handlers. This is not a translation of every distinct historical backend message or all unrelated HR UI copy. No permissions were broadened.
- Production data cleanup completed before application cutover: reviewed manual shipments IDs 8–13 deleted; seven receipt-backed packages are available with 588 pieces, including 450 pieces restored from five shipped packages. Six cached shipment retries invalidated. The sole generated order SO-0001 (ID 7) is cancelled/zeroed and unpaid invoice ID 3 voided/zeroed, preventing residual debt in legacy aggregate reports. Original rows/amounts are preserved in audit #22468; receipt/package identities, earlier audit and stock rows remain. No replacement stock, customer, order, package or shipment was created. Post-cleanup verification found zero remaining shipments at that point; later legitimate new shipments are outside this cleanup.
- Validation: immutable CI [35440483933](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35440483933) passed 986 backend tests, 11 deployment observer tests, Ruff/compilation, frontend strict types/contracts and optimized 89-route build. ESLint has zero errors and five inherited unused-symbol warnings. Signed-in read-only QA passed on the hash-verified local build and live changed pages; EN/RU/UZ return/history controls, search by button/Enter, passport material rows, real production thumbnails and separate history verified. Browser error logs were empty on changed routes. No production business records were created for QA.
- Earlier local preview launch attempts were rejected by automatic approval review. A later read-only probe found the preview already running; its 15 served JS/CSS assets matched the intended local build. QA then proceeded without an alternative launch workaround. Only the isolated SQLite fixture's trusted origin was corrected; production CORS/auth configuration was unchanged.
- Performance: initial serial inventory-batch p95 comparison failed (+18.2%) and activation stopped. Its code path was unchanged; retained evidence and 63 alternating paired samples after 10 warmups resolved timing variation under unchanged 10% median / 15% p95 / 15% payload bounds. Maximum paired median increase 0.90%, p95 increase 5.73%; result counts/payloads identical. An initial HTTPS-versus-loopback comparison was invalid due to different transports and is retained as a measurement error. The first closing HTTPS comparison also failed on inventory-stock/model-groups p95 with stable medians/payloads. Read-only diagnostics found backend CPU below 1%, load 0.26, and intermittent public DNS latency up to 1049ms. The failed samples remain recorded; a separately named, reviewed retry uses the same initial HTTPS baseline and unchanged limits. There is no pre-cutover public HTTPS timing baseline; public closing performance is compared against the immediate post-cutover HTTPS baseline on the same route, so no before/after-public regression claim is made.
- High-risk 30-minute observation completed from `2026-09-19T11:49:59.262554+00:00` to `2026-09-19T12:19:59.474215+00:00` with 61 rounds of all four internal/public health/login checks and no failures. Closing runtime, source/slot, strict logs, database and same-route public performance checks passed. Two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 28/100 connections, zero invalid indexes. Disk 74% backend / 66% frontend. Historical unrelated audit/security risks remain; they were not repaired by this scoped release.
- Database remains `0131_sewing_corrections`; no schema migration introduced, normal startup upgrade was a no-op and seeding disabled. Manifest `f3d5523febf1c09b160404d54746d4c56dd6a71d35d4223a4b53597ce9fe5604`, archive SHA-256 `a6e4e36bd9ea72fd9cd14a5e5de7f853adfbe11c8b37f737f19fc6894e7039f0`, 876 source files verified against the exact application commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:b1a759692bdb59d774e06612cfaa5754bc0987b0282aca031a7c1b1f5562dcf5`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:12c18d8471f054efce67c09b8425df8e6065b9e59bdd19ff42e20559e4cdbafa`.
- Verified pre-cleanup/release backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260919_113426.dump`: mode 0600, 54424412 bytes, 1202 restore objects; SHA-256 `b5fea16c1788c91903cf78fa3c11f08201fcfe047874d7a56ce5def312607b87`, restore-list SHA-256 `578e06c4d4718ef7803c4b942ff98b58609afbad0993fb2348418504c206f6d9`. At this release, rollback used the retained blue release without database downgrade; rollback does not undo the separately authorized shipment reset.
- Worktree `C:/ERP/.codex-work/cutting-shipping-packaging-20260919`; application branch `codex/cutting-shipping-packaging-20260919` pushed, merged and deployed. Release/cleanup/QA/observation evidence is under `outputs/`. Legacy checkout preserved. Item 8 remains a proposal only in `docs/FIRST_GRADE_SINGLES_WORKFLOW.md`: exact-size good pieces without a complete assortment allocate to a separate singles inventory and per-piece sale flow, without double-counting stock.

## Bestpacking login and isolated packaging navigation deployed (2026-09-18)

- LIVE: backend/frontend blue release `20260918_121209`, exact application commit `1c083d6365550d50afa381c851d0fe5dcb669a29`, merged via PR #179. Both source manifests, exact images, symlinks and slot states agree. Green `20260918_113409` remains running for rollback. Frontend activated `2026-09-18T12:24:35.559943+00:00`.
- Bestpacking now lands on Besttex Packaging. Denied old factory landing URLs recover automatically. The access gate follows the current router query during navigation instead of the previous browser location. Packages, Packing Queue, Receive from Sewing, Packaging Reports and sidebar highlighting use the authenticated factory when a query is omitted. Explicit cross-factory/invalid destinations remain denied; Besttex data stays isolated from Milana and Eco. No user permissions or backend authorization rules were broadened.
- Earlier validation passed the reproduced AuthGate transition regression, all four pages' API factory-scope cases, frontend lint (zero errors, five inherited unused-symbol warnings), strict types, contracts and optimized 88-route build; 13 backend report/factory isolation tests and 18 live read-only section checks passed. The first login patch's complete backend suite passed 980 tests. Standard immutable CI [35343423291](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35343423291) passed validation and published the exact-commit images/source.
- At the user's explicit request to deploy fast without extra testing and monitoring, no further local suite, browser/performance exercise or extended observation ran. The earlier preview-server approval rejection was not retried. Required source reconciliation, verified backup, schema check, inactive-slot warm-up, runtime and all four immediate internal/public health/login checks passed. No extended monitoring or signed-browser check is claimed.
- Database remains `0131_sewing_corrections`; no schema migration was introduced. Normal startup Alembic upgrade is a no-op and seeding remained disabled. No business data or account settings changed. Routers validated; two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 21/100 connections, zero invalid indexes. Disk 73% backend / 66% frontend. Historical unrelated risks remain unchanged.
- Manifest `6cafdaedf78bbaca190629139f95c6669086b0159233d4977b47c82a0c7dbd2e`, archive SHA-256 `64f8eae4781814525de046923dedfbcf353e7cac8750547142facd0bd8dea98b`, 867 source files verified against the exact Git commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:fcc5939f38fcc2c85c01ea5741449ad10bbde98fe248e3962a2f4671ec68785f`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:fa55625f5c87736a395630e4b7cc11c3deca10232035daf0d9c698489c57ebce`.
- Backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260918_121209.dump`: mode 0600, 54350685 bytes, 1202 restore objects; SHA-256 `60fcc8202c0047015403ac47d331447a430fd3cc363ffad379380ae068b2ad85`, restore-list SHA-256 `950000a83383bbd0ce5fce49c71de1bb7e5239e50f8ea7228c5f790198fa810f`. Application rollback uses retained green release without database downgrade.
- Worktree `C:/ERP/.codex-work/bestpacking-login-20260918`; implementation branch `codex/bestpacking-login-20260918` pushed/merged/deployed. Record branch `codex/record-bestpacking-login-20260918`. Evidence `outputs/deployment/evidence.json`; legacy checkout preserved; context mirrored to Obsidian.

## Bestpacking login and packaging-section navigation prepared (2026-09-18)

- NOT DEPLOYED: Bestpacking user #52 has the correct Packaging role, BPK department, BST factory and Packaging permissions. Login incorrectly sent every Besttex user to Sewing. In addition, AuthGate read `window.location.search`, which can still contain the previous route's query during a Next.js navigation; leaving the query-less BPK department for a BPK packaging link could therefore be denied as Milana. The routing regression reproduced the denial before the fix.
- PR #179 selects the factory landing from effective permissions and recovers denied old factory landing URLs. AuthGate now uses reactive router search parameters. Packages, Packing Queue, Receive from Sewing, Packaging Reports and active sidebar matching share the signed-in factory default (BST/BPK, ECO/ECP, MIL/PKG). Explicit cross-factory destinations and invalid scopes remain blocked; no permissions or backend authorization rules are broadened. A Suspense boundary supports query-dependent access checks in the optimized build.
- Live read-only checks for user #52 returned HTTP 200 for Besttex package listing, pending package changes, received orders, receive options, receipts and reports. Every matching Milana/Eco request returned HTTP 403 (18 checks). BPK inbox returned 200, BST/PKG/ECP inboxes 403. The direct BPK-scoped page URLs, or reloading the correct scoped URL after a sidebar denial, are the temporary workaround.
- Worktree `C:/ERP/.codex-work/bestpacking-login-20260918`, branch `codex/bestpacking-login-20260918`. Regression tests exercise the actual AuthGate with destination queries differing from the old browser location, all four packaging page API queries with explicit/omitted scope, cross-factory/invalid denials and preserved Sewing/admin homes. Frontend routing contracts and strict TypeScript passed; 13 backend report/factory isolation tests passed. ESLint has no errors and five existing department-page unused-symbol warnings introduced by the already-deployed replacement removal. The first login patch's full backend suite passed 980 tests; the updated optimized 88-route production build also passed.
- Active production/base remains `20260918_113409`, rollback `20260917_100146`, database `0131_sewing_corrections`, verified on both VMs. No business data, account permissions, migration, container or release was changed for this fix. The first stale release workflow was cancelled. Automatic approval review previously rejected starting the localhost preview with `blocked by policy`; browser validation and subsequent immutable deployment gates remain pending. Do not claim either correction is live.
...
- Replacement status API, Cutting/Sewing completion forms, waiting banners/columns, department queues, automatic replacement demand/allocation/notifications and closure blockers are removed. Failed/rejected sewing quantities remain recorded as defects/waste and count as processed loss for Sewing/Packaging/Storage completion and process tracking. Actual passed/packed/stored quantities remain unchanged. Ordinary extra Cutting follows standard output/planning rules.
- Read-only preflight found one historical replacement request for eight pieces, zero cut and zero replaced. Historical request, defect, waste and audit rows are preserved; no business rows, quantities, permissions or schema were modified by deployment. Legacy linked-record deletion/correction guards remain. Database stays `0131_sewing_corrections`; no new migration applied (startup Alembic upgrade was a no-op), and startup seeding stayed disabled. Existing persisted work-order statuses are not bulk rewritten; future workflow actions use the new completion rule.
- Standard immutable CI [35340276787](https://github.com/Shmirzaev/Milana-ERP/actions/runs/35340276787) passed all 980 backend tests, deployment-tool regressions, frontend lint/types/contracts/build and built the exact source commit. Scoped Ruff, Python compilation and diff check passed locally. At explicit user request, no extra local suite, production browser/performance exercise or extended monitoring ran. Backup, candidate warm-up, runtime checks and all four immediate internal/public health/login checks passed at HTTP 200. No extended observation is claimed.
- Both routers validated; two workers per backend slot, zero restarts/OOM/error markers; PostgreSQL 24/100 connections, zero invalid indexes. Disk 73% backend / 66% frontend. Historical unrelated audit/security risks remain unchanged.
- Manifest `6aa0b9d1d293601c5a6e268e816173c13909feda363a3e5439cbe64bf526cfc6`, archive SHA-256 `b342879a9501913eb3a9b4a27bd817d6e8bdd4913769952cf1552cc33aa06c74`, 867 source files checked against the exact commit. Backend `ghcr.io/shmirzaev/milana-erp-backend@sha256:9df42abcdeeb0c7f94e77fd91e379f12d7bded70ecc9a63c81bf5b7bed4a5f45`; frontend `ghcr.io/shmirzaev/milana-erp-frontend@sha256:2503984b68703d98a207343d98111c768f6804e98940b7367a05bc5a50b51ce4`.
- Verified backup `/opt/milana-erp/shared/backups/milana_erp_pre_20260918_113409.dump`: mode 0600, 54310201 bytes, 1202 restore objects; SHA-256 `551a64b412c155bd22c6afa83023c0cc8e92e1f26350a20ec69c1b0d586c7ff7`, restore-list SHA-256 `90e2f6dba77106d458eb8aba825cb6ccbe8da63056b6ec188b33d7f06df4303f`. Rollback uses the retained blue release without database downgrade.
- Worktree `C:/ERP/.codex-work/remove-failed-replacement-20260918`; implementation branch `codex/remove-failed-replacement-20260918` pushed/merged/deployed. Deployment record branch `codex/record-remove-failed-replacement-20260918`. Evidence `outputs/deployment/evidence.json`. Legacy checkout preserved; durable context mirrored to Obsidian.

## Failed-piece replacement removal prepared (2026-09-18)
