...
- The user-mentioned invoice attachment was not present in the task. A basic printable commercial invoice is prepared, but exact reference-layout matching is still pending that document. No merge or deployment is authorized by this feature request.
