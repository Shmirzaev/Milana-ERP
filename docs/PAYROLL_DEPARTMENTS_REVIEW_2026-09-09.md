...
Pre-activation QA corrected existing CSP blocking all four bundle print layouts/Print handlers. Scoped exact style/script hashes preserve the global policy. Browser QA verified the styled BND-0001 document and clicked Print without console errors; `bundle-print-styled.png` supersedes the unstyled bundle screenshots. Candidate artifacts must include this fix.
