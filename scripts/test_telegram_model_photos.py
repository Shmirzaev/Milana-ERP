...
class PhotoTests(unittest.TestCase):
    ...
    def test_bundle_holds_only_actual_variants_using_model_fallback(self):
        ...
        plan['selected'][0]['models'].append({'id':5,'code':'LEGACY-STICKER-1'})
        safety['models'].append({'id':5,'code':'LEGACY-STICKER-1','catalog_scope':'standard'})
        result=bundle(plan,[photo],safety)
        self.assertEqual([r['id'] for r in result['held']],[1,5])
        self.assertEqual([r['id'] for r in result['photos'][0]['models']],[2,3,4])
