...
const required = [
  ...
  ["issued-label edit action requires payroll management", "onEdit={canManagePayroll ? () => openLabelCorrection(label) : undefined}"],
  ["issued-label eligibility also requires payroll management", "editable={canManagePayroll && canCorrectIssuedLabel(label)}"],
